...
func init() {
	...
	runCmd.Flags().StringArrayVar(&run.RunMount, "mount", nil, "Attach a filesystem mount to the container (e.g. type=bind,src=/host,dst=/ctr,ro)")
	...
	runCmd.Flags().StringVarP(&run.RunHostname, "hostname", "", "", "Container host name")
